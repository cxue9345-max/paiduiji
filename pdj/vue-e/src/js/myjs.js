...
var zroomid = 2834474;
var admins = ["Maho55", "沐泥子"];
//22646908; //2834474
// var persons =["<span>123123<br></span>","<span>123123<br></span>","<span>123123<br></span>",
...
function jsontoprint(data) {
    switch (data.cmd) {
        case 'DANMU_MSG':
            ...
            var index = persons.indexOf("<span>" + person + "<br></span>");
            ...
            if (amminIdex != -1) {
                ...
                if (mIdex >= 0) {
                    ...
                    if (persons.length > 0 && dindex != "" && persons.length >= dindex) {
